...
<%@page import="Control.PenangananHome"%>
        ...
        <div id="app">
            <div class="main-wrapper">
                ...
                <sql:query var="penanganan" dataSource="${db}">
                    SELECT * FROM penanganan where id=?;
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Form Edit Penanganan Barang</h1>
                        </div>
                        <div class="card">
                            <c:forEach var="row" items="${penanganan.rows}">
                                <form class="needs-validation" novalidate="" action="../Controller/UpdatePenangananB.jsp?id=${row.id}" method="post">
                                    <div class="card-body">
                                        <input type="hidden" name="id" value="${row.id}" class="form-control" required="" style="width: 123%;">
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label" >Nomor Lab </label>
                                            <div class="col-sm-5">
                                                <input type="text" name="nomor_lab" value="${row.nomor_lab}" class="form-control" required="" style="width: 123%;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="date" name="tanggal" value="${row.tanggal}" class="form-control" required="" style="width: 123%;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="nama_pic" value="${row.nama_pic}" class="form-control">
                                            </div>
                                            <div class="col-sm-3">
                                                <input type="number" name="nip" value="${row.nip}" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" name="nomor_barang" value="${row.nomor_barang}" class="form-control" required="" style="width: 123%;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" name="nama_barang" value="${row.nama_barang}" class="form-control" required="" style="width: 123%;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <textarea name="catatan_perbaikan" value="" class="summernote" placeholder="Harap Di Isi Dengan Jelas">${row.catatan_perbaikan}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <br><br>
