...
<html>
    ...
    <body>
        ...
        <sql:update dataSource="${db}" var="result">
            INSERT INTO penanganan (nomor_lab,tanggal,nama_pic,nip,nomor_pc,catatan_perbaikan,status,jenis_kerusakan) values(?,?,?,?,?,?,'Waiting','Software');
            <sql:param value="${param.nomor_lab}" />
            <sql:param value="${param.tanggal}" />
            <sql:param value="${param.nama_pic}" />
            <sql:param value="${param.nip}" />
            <sql:param value="${param.nomor_pc}" />
