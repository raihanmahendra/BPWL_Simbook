                  ...
                  <form action="saveservlet" method="post">
                    <div class="card-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                          <input type="time" name="durasi_a" required="" class="form-control">
                        </div> -
                        <div class="col-sm-3">
                          <input type="time" name="durasi_b" required="" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="form-group mb-0 row">
                        ...
                        <div class="col-sm-5">
                          <textarea class="form-control" name="kegiatan" required=""  style="width: 123%;"></textarea>
                        </div>
                      </div>
                      <br>
