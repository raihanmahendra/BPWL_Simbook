                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Form Edit Penanganan Software</h1>
                        </div>
                        <div class="card">
                            <c:forEach var="row" items="${penanganan.rows}">
                                <form class="needs-validation" novalidate="" action="../Controller/UpdatePenangananS.jsp?id=${row.id}" method="post">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label" >Nomor PC</label>
                                            <div class="col-sm-2">
                                                <input type="text" name="nomor_pc" value="${row.nomor_pc}" class="form-control" required="" style="width: 123%;">
                                            </div>
                                        </div>
