<%-- 
    Document   : formpengajuanS
    Created on : Jan 27, 2022, 9:36:59 PM
    Author     : User
--%>
...
<html lang="en">
    <head>
        ...
        <title>Penanganan Software &mdash; SIMbook</title>
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Form Penanganan Software</h1>
                        </div>

                        <div class="card">
                            <form class="needs-validation" novalidate="" action="../Controller/PenangananInsertS.jsp" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" name="nomor_pc" class="form-control" required="" style="width: 123%;">
                                        </div>
                                    </div>
                                ...
                                <div class="card-footer text-right">
                                    <button class="btn btn-primary" style="width: 20%;">Kirim</button>
                                </div>
                        </div>
                        </form>
                </div>
