...
<html>
    ...
    <body>
        <%
                ...
                String nomor_barang = request.getParameter("nomor_barang");
                    ...
                    if (conn != null) {
                        if (id != null) {
                            PreparedStatement ps
                                    = conn.prepareStatement("UPDATE penanganan set id=?, nomor_lab=?,tanggal=?,nama_pic=?,nip=?,nomor_barang=?,nama_barang=?,catatan_perbaikan=? where id='" + id + "'");
                            ps.setString(1, id);
                            ps.setString(2, nomor_lab);
                            ps.setString(3, tanggal);
                            ps.setString(4, nama_pic);
                            ps.setString(5, nip);
                            ps.setString(6, nomor_barang);
                            ps.setString(7, nama_barang);
                            ps.setString(8, catatan_perbaikan);
                            ps.executeUpdate();
